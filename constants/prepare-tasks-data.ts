...
export const PREPARE_TASK_DATA: PrepareTaskType[] = [
    {
        ...
        steps: [
          "Identify your location and note nearby vegetation (grassland, forest, scrub) and slopes.",
          "Check whether your area has a defined wildfire season and what months are highest risk.",
          "Find at least two trusted local sources for fire updates (e.g., official civil protection, fire service, meteorology).",
          "Decide a simple household rule for alerts (e.g., 'If an evacuation warning is issued, we prepare to leave immediately').",
    ...
    },
    {
        ...
        image: "communication-image.webp",
        description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum",
why:
      "Wildfires can spread quickly and unpredictably due to wind, slope, and fuel conditions. Risk awareness reduces uncertainty and supports timely, calm action—especially when warnings and information arrive quickly.",
    steps: [
    ...
    {
        id: 4,
        title: "Plann Evacuation & Communication",
